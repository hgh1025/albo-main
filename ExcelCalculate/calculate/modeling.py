...
trade_path = r'C:\\practice\\adminpractice\\ExcelCalculate\\media\\trade_images\\' # \\ 두 개씩 써주기
TRAIN_DATA_DIR = 'C:\\practice\\adminpractice\\ExcelCalculate\\media\\data\\train\\' #기존 데이터
VALIDATION_DATA_DIR = 'C:\\practice\\adminpractice\\ExcelCalculate\\media\\data\\validation\\' #거래완료데이터
...
def exclude_from_training():
    ...
    df = pd.read_csv('C:\\practice\\adminpractice\\ExcelCalculate\\media\\data\\Mytest\\df.csv') #item_price(y), item_img(x)만 꺼내 쓰면 됨
...
def train_and_save_model():
    ...
    model_final.save(r'C:\practice\adminpractice\ExcelCalculate\epoch100_1.h5')
    return None
